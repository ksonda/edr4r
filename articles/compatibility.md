...
| Multi-location retrieval | Supported subset | Explicit IDs through sequential [`edr_location_batch()`](https://ksonda.github.io/edr4r/reference/edr_location_batch.md); optional bounded calendar windows, exact cross-window deduplication, checkpoint/resume, CoverageJSON/CSV, and a finite expanded-plan cap |
...
204 produces a typed empty result rather than a parser failure. For
numeric CoverageJSON ranges, values serialized as JSON strings are
