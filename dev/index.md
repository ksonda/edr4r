...
with no filters returns the full station list as GeoJSON. If you have
[`sf`](https://r-spatial.github.io/sf/) installed, it gets promoted to
an `sf` object automatically:
...
is a small `ggplot2` wrapper over the tidy tibble:
...
puts the stations on a leaflet basemap. Pass `data =` as a named list
keyed by station id (the shape \[edr_explore()\] produces) and each
marker gets a popup with an inline plot and a “Download CSV” link for
that station’s data — embedded as a `data:` URI so the saved HTML is
selfcontained:
...
|----|----|
| [`edr_client()`](https://ksonda.github.io/edr4r/dev/reference/edr_client.md) | construct a client |
| [`edr_landing()`](https://ksonda.github.io/edr4r/dev/reference/edr_landing.md) / [`edr_conformance()`](https://ksonda.github.io/edr4r/dev/reference/edr_conformance.md) | `/`, `/conformance` |
| [`edr_collections()`](https://ksonda.github.io/edr4r/dev/reference/edr_collections.md) / [`edr_collection()`](https://ksonda.github.io/edr4r/dev/reference/edr_collection.md) | `/collections` |
| [`edr_queryables()`](https://ksonda.github.io/edr4r/dev/reference/edr_queryables.md) | `/collections/{id}/queryables` |
| [`edr_locations()`](https://ksonda.github.io/edr4r/dev/reference/edr_locations.md) / [`edr_location()`](https://ksonda.github.io/edr4r/dev/reference/edr_location.md) | `/collections/{id}/locations[/{loc}]` |
| [`edr_items()`](https://ksonda.github.io/edr4r/dev/reference/edr_items.md) / [`edr_item()`](https://ksonda.github.io/edr4r/dev/reference/edr_items.md) | `/collections/{id}/items[/{item}]` |
| [`edr_position()`](https://ksonda.github.io/edr4r/dev/reference/edr_position.md) | `/collections/{id}/position` |
| [`edr_area()`](https://ksonda.github.io/edr4r/dev/reference/edr_area.md) | `/collections/{id}/area` |
| [`edr_cube()`](https://ksonda.github.io/edr4r/dev/reference/edr_cube.md) | `/collections/{id}/cube` |
| [`edr_radius()`](https://ksonda.github.io/edr4r/dev/reference/edr_radius.md) | `/collections/{id}/radius` |
| [`edr_trajectory()`](https://ksonda.github.io/edr4r/dev/reference/edr_trajectory.md) | `/collections/{id}/trajectory` |
| [`edr_corridor()`](https://ksonda.github.io/edr4r/dev/reference/edr_corridor.md) | `/collections/{id}/corridor` |
| [`edr_request()`](https://ksonda.github.io/edr4r/dev/reference/edr_request.md) | low-level escape hatch |
| [`covjson_to_tibble()`](https://ksonda.github.io/edr4r/dev/reference/covjson_to_tibble.md) / [`geojson_to_sf()`](https://ksonda.github.io/edr4r/dev/reference/geojson_to_sf.md) | response parsers |
