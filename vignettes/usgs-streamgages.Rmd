...
USGS beta currently ignores `datetime` on these individual location queries
and returns the latest records. Do not add `chunk` here expecting historical
windows: chunking is intended for EDR implementations that honor the requested
interval.
